...
// @version      Alpha test
// @description  A simple script to set the booking time on the Tagaytay Highlands Teetime website. This script will automatically select the target time if it is available, otherwise it will go the next array of target times
...
setTimeout(() => {
    (function() {
        ...
        const targetTime = ['14:00', '14:10', '14:20', '14:30'];
